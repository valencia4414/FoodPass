            ...
            <template x-if="platilloSeleccionado">
                <div>
                    ...
                    <div class="p-6">
                        ...
                        <button
                            @click="platilloSeleccionado.disponible ? (agregarAlCarrito(platilloSeleccionado), modalDetalle = false) : null"
                            :disabled="!platilloSeleccionado.disponible"
                            :class="!platilloSeleccionado.disponible ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-fp-orange hover:bg-fp-bronze text-white'"
                            class="w-full font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-2">
                            <span class="material-symbols-outlined"
                                x-text="platilloSeleccionado.disponible ? 'shopping_bag' : 'block'"></span>
                            <span
                                x-text="platilloSeleccionado.disponible ? 'Agregar al pedido' : 'Platillo Agotado'"></span>
                        </button>
                    </div>
                </div>
            </template>
